    ...
    <div className='bg-[#012060] flex items-center justify-center w-screen p-6'>
        <div className='flex lg:flex-row md:flex-row flex-col'>
            ...
            <div className='mt-10 lg:mt-0 md:mt-0 lg:ml-10 md:ml-10'>
              ...
              <Link className='text-xl flex items-center mt-5 md:ml-10 lg:ml-10 text-white border-4 p-3 justify-center text-center rounded-lg hover:bg-green-500 transition-colors font-medium border-green-500' to={'/matriculas'}>
                <button className=''>
                  Acessar
                </button>
              </Link>
