                ...
                return (
                  <tr className='hover:bg-gray-100 print:rounded-lg print:border border-gray-300 print:mt-2 print:flex-col print:flex' key={row.code}>
                    {columns.map((column) => {
                      ...
                      return (
                        <td className={`${column.id === 'datam' ? 'border-l-0' : 'border-l print:border-l-0 border-gray-300'} p-1 ${column.label === 'Situação' ? 'border-b print:border-b-0' : 'border-b'} border-gray-300`} key={column.id} align={column.align}>
