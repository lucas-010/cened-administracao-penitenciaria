    ...
    <div className='m-10'>
        <Grid container spacing={2}>
            ...
            <Grid className='print:hidden' item xs={10}  md={1}>
                <button onClick={()=> filterData(date1, date2, date3, date4, statusCourse, idPeni, searchValue)} className='text-lg font-bold w-full transition-colors mt-2 hover:bg-[#ff1b67] hover:shadow-xl text-white rounded-md justify-center p-2 shadow-lg flex items-center bg-[#ff4181]'><MdFilterAlt size={20}/>FILTRAR</button>
            </Grid>
